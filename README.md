...
![Docker Image Build](https://github.com/retaildevcrews/boron/workflows/Docker%20Image%20Build/badge.svg)
...
> Visual Studio Codespaces is the easiest way to evaluate boron as all of the prerequisites are automatically installed
>
> Follow the setup steps in the [Boron readme](https://github.com/retaildevcrews/boron) to setup Codespaces
...
- Initial setup instructions are in the [Boron readme](https://github.com/retaildevcrews/boron)
...
dotnet run -p src/app/boron.csproj -- --auth-type CLI --keyvault-name $He_Name
...
Stop boron by typing Ctrl-C or the stop button if run via F5
